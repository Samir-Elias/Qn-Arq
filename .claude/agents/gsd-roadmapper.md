...
Reference full template: `E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/state.md`.
