...
Use template from `E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
