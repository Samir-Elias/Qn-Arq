...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks E:/Programacion/qn-arq-app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Programacion/qn-arq-app/.claude/get-shit-done
                  → writes to E:/Programacion/qn-arq-app/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
