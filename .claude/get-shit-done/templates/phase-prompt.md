...
<!-- For checkpoint task examples and patterns, see @E:/Programacion/qn-arq-app/.claude/get-shit-done/references/checkpoints.md -->
...
See `E:/Programacion/qn-arq-app/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Programacion/qn-arq-app/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
