...
See E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/discovery.md
...
Use E:/Programacion/qn-arq-app/.claude/get-shit-done/templates/discovery.md.
