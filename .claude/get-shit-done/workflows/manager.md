...
```bash
INIT=$(node "E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat E:/Programacion/qn-arq-app/.claude/get-shit-done/workflows/plan-phase.md
2. Run: node \"E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat E:/Programacion/qn-arq-app/.claude/get-shit-done/workflows/execute-phase.md
2. Run: node \"E:/Programacion/qn-arq-app/.claude/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
