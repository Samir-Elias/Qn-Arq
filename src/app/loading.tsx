export default function HomeLoading() {
  return (
    <main className="px-4 pb-16 sm:px-6 lg:px-12 animate-pulse">
      {/* Hero skeleton */}
      <section className="pb-16 pt-16 sm:pt-20 lg:pt-24">
        <div className="mx-auto max-w-3xl space-y-5 text-center">
          <div className="mx-auto h-3 w-28 rounded bg-black/5" />
          <div className="mx-auto h-10 w-3/4 rounded-lg bg-black/5" />
          <div className="mx-auto h-4 w-2/3 rounded bg-black/5" />
        </div>
      ...
      <section className="space-y-5">
        <div className="flex items-center justify-between">
          <div className="h-6 w-44 rounded-lg bg-black/5" />
        ...
        <div className="grid grid-cols-1 gap-4 min-[480px]:grid-cols-2 min-[480px]:gap-3 sm:grid-cols-3 sm:gap-4">
          {Array.from({ length: 6 }).map((_, i) => (
            ...
            >
              <div className="aspect-[3/2] w-full bg-black/5 min-[480px]:aspect-[4/5]" />
