...
export function WhatsAppFAB() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 transition-shadow hover:shadow-xl hover:shadow-[#25D366]/40 sm:bottom-8 sm:right-6"
